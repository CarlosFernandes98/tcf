    ...
    <div class="download-container">
        <div class="introduction" ref="introSection" :class="{ 'animate': isIntroVisible }">
            <div class="intro-text-container">
                <h2 class="download-title">Community Models Download</h2>
                <p class="intro-text">Faz download das peças da comunidade no formato STL</p>
            </div>
        </div>
...
<script>
import CommunityModelsComponent from '@/components/TCF_Components/CommunityModelsComponent.vue';
